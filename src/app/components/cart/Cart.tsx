...
const Cart = () => {
  return (
    <div className="relative bg-lightGray h-[1466px] mx-auto w-full md:h-[1050px] lg:pl-[3rem] md:px-[2rem] lg:px-0 md:py-[2rem] py-4 px-6 user-cart">
     ...
     <CartProductCard image="graystoneVase" heading="Graystone vase" para="A timeless ceramic vase with 
a tri color grey glaze." />
     </div>
  <div className="mt-12 md:hidden">
  <CartProductCard image="Vase" heading="Basic white vase" para="Beautiful and simple this is
one for the classics." />
  </div>

  <div className="mt-20 ">
     <CartProductCard image="lamps" heading="Graystone vase" para="A timeless ceramic vase with 
a tri color grey glaze." />
     </div>

     <div className="mt-20">
     <CartProductCard image="chairs" heading="Graystone vase" para="A timeless ceramic vase with 
a tri color grey glaze." />
     </div>
