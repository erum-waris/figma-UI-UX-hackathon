...
function BrandCard2(props:CardProps) {
  return (
    <div className='flex flex-col h-[248px] mx-5  m-auto mb-7 gap-[16px] bg-[#F9F9F9] px-[30px] py-[10px] pb-1 hover:bg-gray-200  hover:translate-x-2 hover:translate-y-2 '>
