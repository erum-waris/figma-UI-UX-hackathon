...
function FeaturesSection() {
    return (
        ...
        <div className="relative md:top-[1rem] flex justify-start">
          <Link href="/contact">
          <button className=" mt-[6rem] md:mt-0 mb-8  py-[16px] px-[32px] bg-[#F9F9F9] shadow-lg leading-6 text-[#2a254b] font-satoshi font-normal hover:bg-[#2A254B] hover:text-white transition-all duration-300 ease-in-out text-lg">
            Get in touch
          </button>
          </Link>
        </div>
