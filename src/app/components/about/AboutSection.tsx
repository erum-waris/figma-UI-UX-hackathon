...
function AboutSection() {
  return (
    <section className='flex flex-col'>
      ...
      <button className="w-full md:relative lg:right-0 md:right-16 mt-[1rem] md:mt-4 lg:mt-2 md:w-[250px] md:h-[56px] py-[16px] px-[32px] bg-[#F9F9F9] leading-6 text-[#2A254B] font-satoshi font-normal hover:bg-[#2A254B] hover:text-white transition-all duration-300 ease-in-out">
