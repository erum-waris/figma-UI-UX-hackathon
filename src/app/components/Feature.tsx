    ...
    <section className="flex justify-center items-center">
      <div className="w-full h-auto md:mt-12 mt-14 flex lg:flex-row flex-col">
        ...
        <div className="lg:w-1/2 bg-white shadow-lg flex items-center flex-col">
          <h2 className="font-clash text-[20px] md:text-[24px] leading-[28px] md:leading-[36px] py-10 px-6">
          ...
          <div className="relative md:top-[0.5rem] flex justify-start">
            <Link href="/contact">
        ...
        {/* Right Section */}
        <div className="relative lg:w-1/2 h-[400px]"> {/* Set a fixed height */}
  <Image
    ...
    style={{ objectFit: "cover" }} // Keeps the aspect ratio and fills the container
  />
</div>
